...
export default function ChatBox(){
    return(
        <div>
            <div className="flex justify-between items-center border-2 border-gray-300 rounded-t-4xl p-5">
            ...
            <div className="flex flex-col justify-items-end border-2 border-t-0 border-gray-300 rounded-b-4xl p-5">
            <div>
            ...
            <div>
             <div className="mt-6 flex items-center">
                <input type="text" 
                className="relative bg-gray-100 focus:outline-gray-200 rounded-3xl w-full pl-12 pr-3 py-5 flex items-center border-none text-2xl" 
                id="ask" placeholder="Send message..." />
                <Paperclip className="absolute left-14" />
                <Send className="absolute right-25"/>
                <Tally1 className="absolute right-17" />
